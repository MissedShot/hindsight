...
class BankTemplateConfig(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if retain_structured_chunk_size (nullable) is None
        # and model_fields_set contains the field
        ...
        if self.enable_temporal_retrieval is None and "enable_temporal_retrieval" in self.model_fields_set:
            _dict['enable_temporal_retrieval'] = None
        ...
        # set to None if audit_log_enabled (nullable) is None
        # and model_fields_set contains the field
        if self.audit_log_enabled is None and "audit_log_enabled" in self.model_fields_set:
            _dict['audit_log_enabled'] = None

        # set to None if store_document_text (nullable) is None
        # and model_fields_set contains the field
