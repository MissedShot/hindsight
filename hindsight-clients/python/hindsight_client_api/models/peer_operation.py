...
class PeerOperation(BaseModel):
    """
    Stable async-operation acknowledgement.
    """ # noqa: E501
    operation_id: StrictStr
    deduplicated: Optional[StrictBool] = False
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PeerOperation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PeerOperation from a dict"""
        if obj is None:
            return None
