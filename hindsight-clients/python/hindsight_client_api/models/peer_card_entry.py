...
class PeerCardEntry(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["claim_id", "claim_type", "text", "confidence", "locked"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PeerCardEntry from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PeerCardEntry from a dict"""
        if obj is None:
            return None
