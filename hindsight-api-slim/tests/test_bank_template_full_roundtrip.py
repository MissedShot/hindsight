...
_SAMPLE_VALUES: dict[str, Any] = {
    ...
    "peer_model_min_new_facts": 11,
    "peer_model_cooldown_seconds": 601,
    "peer_model_max_card_entries": 41,
    "peer_model_min_pattern_sources": 3,
    "peer_model_representation_max_tokens": 1400,
